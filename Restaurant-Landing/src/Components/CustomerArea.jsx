            ...
            <div className="carousel-area carousel w-full h-96">
              <div id="item1" className={`carousel-item w-full h-full ${activeItem === 'item1' ? 'block' : 'hidden'}`}>
                <div className="text-area 2xl:w-[600px]">
                  <h1 className='font-Roboto font-normal text-xl text-Aboutclr text-justify w-[350px] sm:w-[450px] md:w-[250px] lg:w-[250px] xl:w-[300px] 2xl:w-[300px] relative left-5 sm:left-10 md:left-4 lg:left-6 xl:left-20 2xl:left-20'>
                ...
                <div className="lower-area flex justify-between relative top-30 sm:top-22 md:top-4 lg:top-4 xl:top-18 2xl:top-20">
                  <div className="lower-text-area relative left-12 sm:left-12 md:left-3 lg:left-5 xl:left-10 2xl:left-10">
                  ...
                  <div className="image-area relative right-10 sm:right-10 md:right-3 lg:right-5 xl:right-10 2xl:right-10 flex flex-col items-center">
                      <img src={Customer} alt="Customer" className='' />
                      <span className='w-12 h-1 bg-foodclr mt-1 sm:mt-2 md:mt-0 xl:mt-4 2xl:mt-2'></span>
                </div>
                </div>
              ...
              <div id="item2" className={`carousel-item w-full h-full ${activeItem === 'item2' ? 'block' : 'hidden'}`}>
                ...
                <div className="lower-area flex justify-between relative top-38 sm:top-30 md:top-10 lg:top-11 xl:top-28 2xl:top-20">
                  <div className="lower-text-area relative left-12 sm:left-12 md:left-3 lg:left-5 xl:left-10 2xl:left-10">
                    <h3 className='text-AboutNmbr font-bold text-lg font-BebusNeue'>KHALID AL DAWSRY</h3>
                    <p className='text-Aboutclr font-Roboto text-sm'>Jeddah, Saudi</p>
                  </div> 
                  ...
                  <div className="image-area relative right-10 sm:right-10 md:right-3 lg:right-5 xl:right-10 2xl:right-10 flex flex-col items-center">
                      <img src={Customer} alt="Customer" className='' />
                      <span className='w-12 h-1 bg-foodclr sm:mt-1 md:mt-1 lg:mt-0 xl:mt-8 2xl:mt-2'></span>
                </div>
                </div>
