...
const Footer = () => {
  ...
  return (
    <div className='bg-footer-bg bg-no-repeat bg-cover h-230 sm:h-240 md:h-140 lg:h-140 xl:h-140 2xl:h-160 footer-area md:overflow-hidden'>
      ...
      <div className="footer-socials flex justify-between w-[280px] sm:w-[280px] md:w-[280px] lg:w-[280px] xl:w-[280px] 2xl:w-[280px] relative top-14 left-12 xs:top-14 xs:left-20 sm:top-36 sm:left-46  md:top-30 md:left-58 lg:top-36 lg:left-100 xl:top-50 xl:left-152 2xl:top-60 2xl:left-180">
