  ...
  return (
    <div className='bg-footer-bg bg-no-repeat bg-cover h-230 sm:h-240 md:h-140 lg:h-140 xl:h-140 2xl:h-160 footer-area md:overflow-hidden'>
      <div className="footer-text-area">
        <h1 className='font-BebusNeue text-white text-4xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-5xl font-bold text-center sm:w-[600px] md:w-[700px] lg:w-[1000px] xl:w-[1400px] 2xl:w-[1400px] relative top-10 sm:top-20 sm:left-10 md:top-20 md:left-20 lg:top-30 lg:left-10 xl:top-30 xl:left-20 2xl:top-30 2xl:left-50'>
      ...
      <div className="footer-socials flex justify-between w-[280px] sm:w-[280px] md:w-[280px] lg:w-[280px] xl:w-[280px] 2xl:w-[280px] relative top-14 left-20 sm:top-36 sm:left-46  md:top-30 md:left-58 lg:top-36 lg:left-100 xl:top-50 xl:left-152 2xl:top-60 2xl:left-180">
       ...
       <a href="/"><img src={Lin} alt="Linkedin"/></a> 
        ...
        <h5 className='text-white text-normal text-xl font-Montserrat relative top-18 left-14 sm:top-44 sm:left-40 md:top-36 md:left-54  lg:top-40 lg:left-96 xl:top-56 xl:left-148 2xl:top-66 2xl:left-176'>© 2023 <span className='text-xl text-nioclr'>Niomax </span>All Rights Reserved</h5>
